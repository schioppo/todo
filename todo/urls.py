...
from .views import TodoListView, TodoDetailView, TodoCreateView, TodoUpdateView, TodoDeleteView, TodoSignupView

urlpatterns = [
    path('signup/', TodoSignupView.as_view(), name='todo_signup'),
